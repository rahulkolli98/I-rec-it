...
const Loader: React.FC<LoaderProps> = ({ type, customMessage }) => {
  ...
  return (
    ...
    >
      <StyledWrapper $mediaType={mediaTypeToUse}>
        <div className="pl">
      ...
      <motion.p 
        className="text-zinc-400 mt-6 text-sm"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        transition={{ delay: 0.5, duration: 0.5 }}
      >
        {customMessage || (mediaTypeToUse === 'books' 
          ? "Finding the perfect book for your mood..." 
...
interface StyledWrapperProps {
  $mediaType: 'books' | 'movies';
}

const StyledWrapper = styled.div<StyledWrapperProps>`
  --bg: transparent;
  --primary1: ${props => props.$mediaType === 'books' ? '#8B5CF6' : '#FF6B00'};
  --primary2: ${props => props.$mediaType === 'books' ? '#D946EF' : '#FF9E00'};
  --fg-t: rgba(255, 255, 255, 0.9);
  --trans-dur: 0.3s;
  display: flex;
